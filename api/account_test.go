...
func TestCreateAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "InmternalServerCreateAccountError",
			body: gin.H{
				"currency": account.Currency,
			},
			setupAuth: func(t *testing.T, request *http.Request, maker token.Maker) {
		...
		{
			name: "InmternalServerGetAccountError",
			body: gin.H{
				"currency": account.Currency,
			},
			setupAuth: func(t *testing.T, request *http.Request, maker token.Maker) {
...
func TestListAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:  "InvalidPageID",
			query: Query{pageID: 0, pageSize: 10},
			setupAuth: func(t *testing.T, request *http.Request, maker token.Maker) {
		...
		},
		{
			...
			query: Query{pageID: 1, pageSize: 100},
			setupAuth: func(t *testing.T, request *http.Request, maker token.Maker) {
				addAuthorization(t, request, maker, authorizationTypeBearer, "unauthorized_user", time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
...
func TestUpdateAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "InternalServerGetAccountError",
			body: gin.H{
				"id":     account.ID,
				"amount": amount,
			},
		...
		{
			name: "InternalServerUpdateAccountError",
			body: gin.H{
				"id":     account.ID,
				"amount": amount,
			},
